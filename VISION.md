...
Every user starts with the **Personal Pack** (calendar, email, weather, tasks, travel, bills).

**Vertical packs** in `apps/` add domain-specific connectors and reasoning on top.
