...
const ITEM_COLUMNS = `id, user_id, name, status, due_at, scheduled_at, completed_at,
  priority, description, kind, owner_actor_id, context,
  origin_context, tags, refs, lifecycle, source, ingested_at, state,
...
export class PostgresItemStore implements ItemStore {
  ...
  async save(item: Item): Promise<Item> {
    await this.pool.query(
      `INSERT INTO items (
         id, user_id, name, status, due_at, scheduled_at, completed_at,
         priority, description, kind, owner_actor_id, context,
         origin_context, tags, refs, lifecycle, source, ingested_at, state,
         occurred_at, created_at, updated_at
